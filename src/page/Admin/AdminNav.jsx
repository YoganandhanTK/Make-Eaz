  ...
  return (
    <>
        ...
        <section className='showside'>
            <div className="list">
            <a className='listItem' href="/admin/addteacher">Add Teacher</a>
            <a className='listItem' href="/admin/addstudent">Add Student</a>
            <a className='listItem' href="/admin/addclass">Add Class</a>
            <a className='listItem' href="#">Report</a>
            <a className='listItem' href="/admin/dash">Dashboard</a>
            <a className='listItem' href="/">Logout</a>
            </div>
        </section>
    </>
  );
